...
def run_test_central(phi0, m, repetitions):
    eval_arr = [5, 10, 20, 30, 50, 100, 150, 200, 300, 500, 1000, 1500, 3000, 5000, 7000, 10000]
    acc_arr = []

    with (open("./results/avg_rank_results_2.txt", "a")) as f:
        for n in eval_arr:
